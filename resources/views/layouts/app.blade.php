...
<head>
    ...
    <title>Dr. Rafiq Zakaria Institute of higher learning || Admin</title>
    ...
    <!-- ritch editor -->
    <link rel="stylesheet" type="text/css" href="/assets/backend/trumbowyg/ui/trumbowyg.min.css">
    <script src="/assets/backend/trumbowyg/trumbowyg.min.js"></script>
    <script>
        $('.date-own').datepicker({
            minViewMode: 2,
            format: 'yyyy'
        ...
        function validateForm() {
            var x = document.forms["myform"]["album_type"].value;
            var y = document.forms["myform"]["album_name"].value;
            if (x == "new" && y == "") {
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="/assets/images/front_end/user_icon.jpg">
                            </a>
