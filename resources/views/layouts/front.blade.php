...
<head>
    ...
    <style>
        .background {
            background: linear-gradient(to top, rgb(0, 0, 0, 0.3), rgb(0, 0, 0, 0.3)), url('/assets/images/slider.jpg');
        ...
        @media only screen and (max-width: 600px) {
            .background {
                background: url('/assets/images/front_end/slider.jpg');
                background-size: cover;
                height: 100vh;
                display: flex;
                justify-content: center;
...
<body>
    <header>
     <div class="container nav-menu">
      <div class="row">
        <div class="col-md-12">
           <a href="index.html"><img src="/assets/images/logo.png" class="responsive-logo img-fluid" alt="responsive-logo"></a>
        </div>
     </div>
     <div class="row">
        <div class="col-md-12">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="address">
                            <h3>Contact us</h3>
                            <p><span>Address: </span> Dr. Rafiq Zakaria Campus Post Box No 27, Dr. Rafiq Zakaria
    ...
    <script src="/assets/js/animated-masonry-gallery.js"></script>
    @yield('js')
</body>
